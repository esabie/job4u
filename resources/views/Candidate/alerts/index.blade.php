...
<section class="bg-slate-50 min-h-screen">
    <div class="max-w-5xl mx-auto px-6 py-12">
        ...
        <!-- CREATE ALERT -->
        <div class="bg-white rounded-2xl shadow-sm border p-8 mb-10">
            ...
            <form method="POST" action="{{ route('candidate.alerts.store') }}"
                ...
                <div class="md:col-span-2 flex justify-end">
                    <button type="submit"
                            ...
                            class="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-xl bg-[#1E3A6D] text-white
        ...
        <div class="space-y-4">
            @forelse ($alerts as $alert)
                <div class="bg-white rounded-2xl shadow-sm border p-6 flex items-start justify-between gap-4">
                    <div>
