...
@section('heading', 'Please try again')
@section('message', 'Your session ended after a period of inactivity, so this form could not be submitted securely. Go back, refresh the page, and continue where you left off.')
